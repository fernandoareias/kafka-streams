...
public class CreditCardCreated extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<CreditCardCreated> ENCODER =
      new BinaryMessageEncoder<CreditCardCreated>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<CreditCardCreated> DECODER =
      new BinaryMessageDecoder<CreditCardCreated>(MODEL$, SCHEMA$);
  ...
  public static BinaryMessageDecoder<CreditCardCreated> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<CreditCardCreated>(MODEL$, SCHEMA$, resolver);
  }
   ...
   */
  public static com.fernando.CreditCardCreated.Builder newBuilder() {
    return new com.fernando.CreditCardCreated.Builder();
  }
   ...
   * @return A new CreditCardCreated RecordBuilder
   */
  public static com.fernando.CreditCardCreated.Builder newBuilder(com.fernando.CreditCardCreated.Builder other) {
    if (other == null) {
      return new com.fernando.CreditCardCreated.Builder();
    } else {
      return new com.fernando.CreditCardCreated.Builder(other);
    }
  }
   ...
   * @return A new CreditCardCreated RecordBuilder
   */
  public static com.fernando.CreditCardCreated.Builder newBuilder(com.fernando.CreditCardCreated other) {
    if (other == null) {
      return new com.fernando.CreditCardCreated.Builder();
    } else {
      return new com.fernando.CreditCardCreated.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CreditCardCreated>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.fernando.CreditCardCreated.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.fernando.CreditCardCreated other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.key)) {
        this.key = data().deepCopy(fields()[0].schema(), other.key);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fernando.CreditCardCreated.Builder setKey(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fernando.CreditCardCreated.Builder clearKey() {
      key = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fernando.CreditCardCreated.Builder setCardNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fernando.CreditCardCreated.Builder clearCardNumber() {
      cardNumber = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fernando.CreditCardCreated.Builder setPortadorDocument(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fernando.CreditCardCreated.Builder clearPortadorDocument() {
