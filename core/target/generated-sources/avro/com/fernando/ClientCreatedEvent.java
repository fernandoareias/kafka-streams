...
public class ClientCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<ClientCreatedEvent> ENCODER =
      new BinaryMessageEncoder<ClientCreatedEvent>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<ClientCreatedEvent> DECODER =
      new BinaryMessageDecoder<ClientCreatedEvent>(MODEL$, SCHEMA$);
  ...
  public static BinaryMessageDecoder<ClientCreatedEvent> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<ClientCreatedEvent>(MODEL$, SCHEMA$, resolver);
  }
   ...
   */
  public static com.fernando.ClientCreatedEvent.Builder newBuilder() {
    return new com.fernando.ClientCreatedEvent.Builder();
  }
   ...
   * @return A new ClientCreatedEvent RecordBuilder
   */
  public static com.fernando.ClientCreatedEvent.Builder newBuilder(com.fernando.ClientCreatedEvent.Builder other) {
    if (other == null) {
      return new com.fernando.ClientCreatedEvent.Builder();
    } else {
      return new com.fernando.ClientCreatedEvent.Builder(other);
    }
  }
   ...
   * @return A new ClientCreatedEvent RecordBuilder
   */
  public static com.fernando.ClientCreatedEvent.Builder newBuilder(com.fernando.ClientCreatedEvent other) {
    if (other == null) {
      return new com.fernando.ClientCreatedEvent.Builder();
    } else {
      return new com.fernando.ClientCreatedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ClientCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.fernando.ClientCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.fernando.ClientCreatedEvent other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.key)) {
        this.key = data().deepCopy(fields()[0].schema(), other.key);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fernando.ClientCreatedEvent.Builder setKey(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fernando.ClientCreatedEvent.Builder clearKey() {
      key = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fernando.ClientCreatedEvent.Builder setCardNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fernando.ClientCreatedEvent.Builder clearCardNumber() {
      cardNumber = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fernando.ClientCreatedEvent.Builder setProposalNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fernando.ClientCreatedEvent.Builder clearProposalNumber() {
      proposalNumber = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fernando.ClientCreatedEvent.Builder setDocument(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fernando.ClientCreatedEvent.Builder clearDocument() {
      document = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fernando.ClientCreatedEvent.Builder setProduct(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fernando.ClientCreatedEvent.Builder clearProduct() {
      product = null;
